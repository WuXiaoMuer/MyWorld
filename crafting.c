...
void InitCraftingRecipes(void)
{
    ...
    // --- Gold tools ---
    ADD_RECIPE(ITEM_GOLD_INGOT, 3, TOOL_GOLD_PICKAXE, 1, STR_RECIPE_GOLD_PICK, false);
    ...
    ADD_RECIPE(ITEM_GOLD_INGOT, 8, ARMOR_GOLD_CHESTPLATE, 1, STR_RECIPE_GOLD_CHEST, true);
    ADD_RECIPE(ITEM_GOLD_INGOT, 7, ARMOR_GOLD_LEGGINGS, 1, STR_RECIPE_GOLD_LEGS, true);
    ADD_RECIPE(ITEM_GOLD_INGOT, 4, ARMOR_GOLD_BOOTS, 1, STR_RECIPE_GOLD_BOOTS, true);
    // --- Diamond armor ---
    ADD_RECIPE(ITEM_DIAMOND, 5, ARMOR_DIAMOND_HELMET, 1, STR_RECIPE_DIAMOND_HELMET, true);
    ADD_RECIPE(ITEM_DIAMOND, 8, ARMOR_DIAMOND_CHESTPLATE, 1, STR_RECIPE_DIAMOND_CHEST, true);
    ADD_RECIPE(ITEM_DIAMOND, 7, ARMOR_DIAMOND_LEGGINGS, 1, STR_RECIPE_DIAMOND_LEGS, true);
    ADD_RECIPE(ITEM_DIAMOND, 4, ARMOR_DIAMOND_BOOTS, 1, STR_RECIPE_DIAMOND_BOOTS, true);
    ...
    ADD_RECIPE(BLOCK_STONE, 1, BLOCK_STONE_BUTTON, 1, STR_RECIPE_STONE_BUTTON, false);
    ...
    ADD_RECIPE2(ITEM_ABYSS_CRYSTAL, 4, BLOCK_OBSIDIAN, 2, BLOCK_ABYSS_ALTAR, 1, STR_RECIPE_ABYSS_ALTAR, true);
...
void DrawCraftingPanel(int panelX, int panelY, int panelW, int visibleCount, int slotH, int pad, bool showAdvanced)
{
    ...
    for (int i = startIdx; i < endIdx; i++) {
        ...
        CraftRoundedRect((int)btnRect.x, (int)btnRect.y, (int)btnRect.width, (int)btnRect.height, 0.06f, bgColor);
        DrawRectangleLines((int)btnRect.x, (int)btnRect.y, (int)btnRect.width, (int)btnRect.height, rowBorder);
